...
class Cvxnnregression(nn.Module):
    def __init__(self):
        ...
        self.neuron_num = 100
        self.hidden1 = nn.Linear(in_features=9,out_features=self.neuron_num,bias=True) #200
    ...
    def forward(self,x):
        ...
        alpha = F.relu(nn.Linear(9, self.neuron_num)(x0[0][0:9]))
    ...
    def unrollL(self,x0,alpha,p):
        ...
        m = nn.Linear(9, self.neuron_num)(hw.t())
        # print("m0:",m)
